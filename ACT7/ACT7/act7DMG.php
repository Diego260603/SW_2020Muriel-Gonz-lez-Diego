...
$contrasenia = preg_match("/([\w|\/|\!|\¡|\?|\¿|\.|\,|\-|\_|\@|\#|\"|\$|\%]){8,}/",$CONTRASENIA);//\gm
if ($nombre==true)
{
  if ($apPat==true)
  {
    if ($apMat==true)
    {
      if ($rfc==true)
      {
        ...
        {
          echo "Su contraseña ".$CONTRASENIA." es insegura, por favor utilice una extención de mínimo 8 caracteres entre los caules alla mayúsculas, minúsculas, números y signos de puntuación";
        }
      }
      else
      {
